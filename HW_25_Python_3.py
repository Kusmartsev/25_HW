...
if item_1 < comp_item:
    ...
    print('Переменная item_1 больше или равнаэ', comp_item)
...
#  в значении переменной currency_result высчитать
...
#  31.5 Сделать elif в котором будет условие:
#  если target_currency равен ‘uah’, то в теле этого if
#  в значении переменной currency_result высчитать
